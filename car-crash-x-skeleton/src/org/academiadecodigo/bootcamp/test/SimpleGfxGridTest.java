    ...
    private static TestResult stepThree(SimpleGfxGrid grid) {
        ...
        try {
            ...
            if (gridPos.getX() != SimpleGfxGrid.PADDING + grid.getCellSize() || gridPos.getY() != SimpleGfxGrid.PADDING) {
                System.out.println("grid pos: " + gridPos.getX());
                System.out.println("cellsize: " + SimpleGfxGrid.PADDING + grid.getCellSize());
                return new TestResult(false, "shape is not properly placed on the grid");
            }
        ...
        try {
            ...
            while (cycles > 0) {
                ...
                if (gridPos.getX() != pos.getCol() * grid.getCellSize() + SimpleGfxGrid.PADDING
                    ...
                    return new TestResult(false, "shape position coordinated are wrong after moving down");
                }
                ...
                if (gridPos.getX() != pos.getCol() * grid.getCellSize() + SimpleGfxGrid.PADDING
                        || gridPos.getY() != pos.getRow() * grid.getCellSize() + SimpleGfxGrid.PADDING) {
                    return new TestResult(false, "shape position coordinated are wrong after moving right");
                }
                ...
                if (gridPos.getX() != pos.getCol() * grid.getCellSize() + SimpleGfxGrid.PADDING
                        || gridPos.getY() != pos.getRow() * grid.getCellSize() + SimpleGfxGrid.PADDING) {
                    return new TestResult(false, "shape position coordinated are wrong after moving up");
                }
                ...
                if (gridPos.getX() != pos.getCol() * grid.getCellSize() + SimpleGfxGrid.PADDING
                        || gridPos.getY() != pos.getRow() * grid.getCellSize() + SimpleGfxGrid.PADDING) {
                    return new TestResult(false, "shape position coordinated are wrong after moving left");
                }
